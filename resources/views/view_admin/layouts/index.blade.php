...
<head>
  ...
  <title>Dashboard - AEC</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="admin_assets/assets/img/favicon.png" rel="icon">
  ...
  * Template URL: https://bootstrapmade.com/nice-admin-bootstrap-admin-html-template/
  @livewireScripts* Author: BootstrapMade.com
...
<body>
  ...
  <!-- ======= Header ======= -->
   @include('view_admin/partials/header')
  <!-- End Header -->
  <!-- ======= Sidebar ======= -->
  @include('view_admin/partials/sidebar')
  <!-- End Sidebar-->
  ...
  <!-- ======= Footer ======= -->
  @include('view_admin/partials/footer')
  <!-- End Footer -->
